...
if(isset($_POST['submit']))
{
	...
	$insert="INSERT INTO `users`(`type_id`, `lastname/firstname/midname`, `gender`, `address`, `email`, `contact_number`, `username`, `password`, `stat_id`) VALUES ('$position','$name','$gender','$address','$email','$contact','$username','$password','$status')";
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="input-group has-validation">
      ...
      <input type="number" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" name="cnumber" required>
      <div class="invalid-feedback">
					...
					while($row = $result-> fetch_assoc()){
						...
						echo '
							...
							<tr>
								...
								<td>
									<button class="btn btn-dark my-1" ><a class="text-light" href="user_update.php?updateid='.$id.'" >Update</a></button>
